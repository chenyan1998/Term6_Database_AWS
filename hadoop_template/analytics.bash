...
sudo -u hadoop /opt/sqoop-1.4.7/bin/sqoop import --bindir /opt/sqoop-1.4.7/lib/ --connect jdbc:mysql://172.31.74.76/kindle_reviews?useSSL=false --table Reviews --username root --password '&V]xM);}^$ts&9U-hC[C'
